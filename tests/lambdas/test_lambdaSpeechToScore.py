...
from tests.lambdas.constants_test_lambdaSpeechToScore import expected_GetAccuracyFromRecordedAudio, text_dict, \
    expected_get_speech_to_score, expected_with_audio_files_splitted_list, expected_with_selected_word_valid_index
...
def assert_get_speech_to_score_tuple_ok(cls, language, expected, expected_num_words, remove_random_file: bool):
    import glob
    import shutil
    set_seed()
    path = EVENTS_FOLDER / f"test_{language}.wav"
    ...
    check_output_with_splitted_audio_files(cls, json_loaded, expected_output, check_audio_files=True)
...
class TestGetAccuracyFromRecordedAudio(unittest.TestCase):
    ...
    def test_get_speech_to_score_tuple_de_ok_not_remove_random_file(self):
        assert_get_speech_to_score_tuple_ok(
            self, "de", expected_with_audio_files_splitted_list, expected_num_words=5, remove_random_file=False
        )

    def test_get_speech_to_score_tuple_en_ok_not_remove_random_file(self):
        assert_get_speech_to_score_tuple_ok(
            self, "en", expected_with_audio_files_splitted_list, expected_num_words=5, remove_random_file=False
        )

    def test_get_speech_to_score_tuple_de_ok_remove_random_file(self):
        assert_get_speech_to_score_tuple_ok(
            self, "de", expected_with_audio_files_splitted_list, expected_num_words=5, remove_random_file=True
        )

    def test_get_speech_to_score_tuple_en_ok_remove_random_file(self):
        assert_get_speech_to_score_tuple_ok(
            self, "en", expected_with_audio_files_splitted_list, expected_num_words=5, remove_random_file=True
        )
